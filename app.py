...
Runs the complete test suite in a separate Python process.

The test suite uses a temporary SQLite database.

Production economic data is not intentionally used.

Access requires ADMIN_KEY.
